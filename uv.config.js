(function () {
    ...
    self.__u22$config = {
        ...
        handler: new URL('u22.handler.js', _base).href,
        client:  new URL('u22.client.js',  _base).href,
        bundle:  new URL('u22.bundle.js',  _base).href,
        config:  new URL('u22.config.js',  _base).href,
